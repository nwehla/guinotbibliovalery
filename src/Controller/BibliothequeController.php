...
class BibliothequeController extends AbstractController
{
    ...
    /**
     * @Route("/admin/administration", name="bibi_administration")
     */
    ...
    /**
     * @Route("/admin/systeme",name="bibi_systeme")
     */
    ...
    /**
     * @Route("/admin/utilisateurs", name="bibi_utilisateur")
     */
    ...
    /**
     * @Route("/admin/contenu", name="bibi_contenu")
     */
    ...
    /**
     * @Route("/admin/categorie", name="bibi_categorie")
     */
    ...
    /**
     * @Route("/admin/image", name="bibi_image")
     */
    ...
    /**
     * @Route("/admin/extension", name="bibi_extension")
     */
